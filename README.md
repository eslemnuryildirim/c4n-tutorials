1: Mevcut Paketleri Keşfetme ve Kurulum
...
Ödev Detayı: 1. values.yaml dosyasını export edin. 2. Replica sayısını 1'den 3'e çıkarın. 3. Uygulamanın 1 cpu, 2 gb memory ile çalışmasını sağlayın. 4. helm upgrade komutuyla sistemi güncelleyin.
...
Ödev Detayı: 1. Hatalı bir imaj etiketiyle upgrade yapın. 2. kubectl get pods ile hatayı (ImagePullBackOff) görün. 3. helm history ile geçmişi listeleyin. 4. helm rollback komutuyla çalışan son versiyona saniyeler içinde geri dönün.
